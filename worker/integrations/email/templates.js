 ...
 *
 *  · **Cliente** (`quoteConfirmation`, `contactConfirmation`). Solo lo que
 *    necesita para reconocer su solicitud y saber qué pasa después. NO se envía
 *    el alcance declarado, ni el desglose del cálculo, ni las notas internas: es
 *    información técnica de su propia infraestructura y el correo es un canal
 *    que atraviesa servidores de terceros y se queda archivado años.
 *  · **Interno** (`internalQuoteAlert`). El resumen comercial suficiente para
 *    decidir si llamar, sin sustituir a la ficha del panel, que es la fuente de
 *    verdad.
 *
 * Reglas comunes:
 *
